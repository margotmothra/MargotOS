...
TEMP_DIR="/tmp/margotos-comparison-$$"
TIMESTAMP=$(date +"%Y-%m-%d_%H-%M-%S")
REPORT_FILE="$HOME/margotos-config-comparison-$TIMESTAMP.txt"

# Default comparison targets
DEFAULT_REPO="https://gitlab.com/zaney/margotos.git"
DEFAULT_BRANCH="main"
...
show_usage() {
  ...
  echo "                          (default: https://gitlab.com/zaney/margotos.git)"
  ...
  echo "  $0 -r https://github.com/user/margotos.git -b dev"
...
perform_comparison() {
  ...
  # Check if we're in a margotos directory
