  ...
  wayland.windowManager.hyprland = {
    settings = {
      windowrule = [
        ...
        "tag +browser, class:^([Zz]en-alpha|[Zz]en-beta|[Zz]en-browser|[Zz]en)$"
        ...
        "float, class:^(kitty-spotify-player)$"
        ...
        "opacity 0.7 0.6, class:^(kitty)$"
        "opacity 0.7 0.6, class:^(kitty-dropterm)$"
        "opacity 0.7 0.6, class:^(kitty-spotify-player)$"
      ...
      windowrulev2 = [
        # Transparency for Zen browser handled by Hyprland instead of extension
        "opacity 1.0 1.0, class:^([Zz]en-alpha|[Zz]en-beta|[Zz]en-browser|[Zz]en)$"
      ];
    };
  };
}
