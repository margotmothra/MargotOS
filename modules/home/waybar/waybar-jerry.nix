  ...
  programs.waybar = {
    ...
    settings = [
      {
        ...
        modules-center = [ "network" "cpu" "clock" "memory" "disk" ]; # Eterna: [ "hyprland/window" ]
        modules-left = [ "custom/startmenu" "hyprland/window" "pulseaudio" ]; # Eternal:  [ "hyprland/workspaces" "cpu" "memory" "network" ]
        ...
        "disk" = {
          format = " {free}";
          tooltip = true;
          # Not working with margotos window open then closes
    ...
    style = concatStrings [
      ''
        * {
          font-size: 16px;
          font-family: Maple Mono NF, Font Awesome, sans-serif;
          font-weight: bold;
        }
        window#waybar {
          /*
