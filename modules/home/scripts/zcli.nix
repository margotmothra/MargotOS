...
pkgs.writeShellScriptBin "zcli" ''
  ...
  # ==================================
  #
  #    Purpose: NixOS system management utility for MargotOS distribution
  ...
  #
  # Variables:
  # PROJECT             - Base directory name (ddubsos/margotos)
  ...
  # --- Configuration ---
  PROJECT="margotos"   #ddubos or margotos
  PROFILE="${profile}"
  ...
  print_help() {
    echo "MargotOS CLI Utility -- version $VERSION"
    echo ""
