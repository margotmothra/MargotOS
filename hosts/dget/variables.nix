{
  ...
  gitUsername = "margot";
  gitEmail = "margotmothra@gmail.com";
  ...
  extraMonitorSettings = "
    ...
    monitor = DP-3, 1920x1080@144, 3440x-475, 1, transform, 1
    
    # Workspace assignments - DP-1 gets odd, DP-3 gets even
  ...
  stylixImage = ../../wallpapers/snowgirl.jpg;
  ...
  # Set Waybar
  #  Available Options:
  #waybarChoice = ../../modules/home/waybar/waybar-mechabar-pure.nix;
  # waybarChoice = ../../modules/home/waybar/waybar-ddubs.nix;
  #waybarChoice = ../../modules/home/waybar/waybar-ddubs-2.nix;
  waybarChoice = ../../modules/home/waybar/mecha/mecha.nix;
